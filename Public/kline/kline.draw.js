...
var RequestData = function(showLoading) {
    ...
    $(document).ready(GLOBAL_VAR.G_HTTP_REQUEST = $.ajax({
        ...
        // data:"needTickers=1&symbol=qtum2cny&type=1min&since=1503297540000",
        timeout: 30000,
        created: Date.now(),
        beforeSend: function() {
